...
namespace LuoCoreFastGithub.Configuration
{
    ...
    /// LuoCoreFastGithub配置
    /// </summary>
    public class LuoCoreFastGithubConfig
    {
        ...
        public LuoCoreFastGithubConfig(IOptionsMonitor<LuoCoreFastGithubOptions> options)
        {
        ...
        /// </summary>
        /// <param name="options"></param>
        private void Update(LuoCoreFastGithubOptions options)
        {
