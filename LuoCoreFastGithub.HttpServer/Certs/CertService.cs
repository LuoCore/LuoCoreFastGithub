...
namespace LuoCoreFastGithub.HttpServer.Certs
{
    /// <summary>
    /// 证书服务
    /// </summary>
    sealed class CertService
    {
        ...
        /// 获取证书文件路径
        /// </summary>
        public string CaCerFilePath { get; } = OperatingSystem.IsLinux() ? $"{CACERT_PATH}/LuoCoreFastGithub.crt" : $"{CACERT_PATH}/LuoCoreFastGithub.cer";

        /// <summary>
        /// 获取私钥文件路径
        /// </summary>
        public string CaKeyFilePath { get; } = $"{CACERT_PATH}/LuoCoreFastGithub.key";
        ...
        public bool CreateCaCertIfNotExists()
        {
            ...
            var subjectName = new X500DistinguishedName($"CN={nameof(LuoCoreFastGithub)}");
